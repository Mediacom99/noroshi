...
- [ ] **QUAL-01**: Scheduler depends on a Checker interface, not concrete `*HTTPChecker`
...
- [ ] **QUAL-03**: Store methods either persist `statusCode` to a `last_status_code` DB column or remove the unused parameter from signatures
