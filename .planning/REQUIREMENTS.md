...
- [x] **CICD-01**: GitHub Actions workflow with parallel lint and test jobs
...
- [x] **CICD-03**: Build verification with `CGO_ENABLED=0 go build ./cmd/monitor/`
- [x] **CICD-04**: `go vet ./...` passes in CI
